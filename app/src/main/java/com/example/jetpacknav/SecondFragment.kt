...
class SecondFragment() : Fragment() {
    ...
    companion object{
        ...
        const val meal = "meal"
        const val dish = "dish"
        const val recipeOfDish = "recipeOfDish"
        const val url = "url"
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.nameOfMeal.text = arguments?.getString(meal)
        binding.nameOfDish.text = arguments?.getString(dish)
        binding.recipeOfDish.text = arguments?.getString(recipeOfDish)
    }
